...
# -*- encoding: utf-8 -*-
# stub: rakuna-content-json 1.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rakuna-content-json"
  s.version = "1.0.1"
  ...
  s.date = "2015-11-30"
  s.description = "`rakuna-content-json` adds mixins for parsing and generating JSON"
  ...
  s.files = [
    ...
    "Rakefile",
    "VERSION",
    "lib/rakuna/accepts/json.rb",
    "lib/rakuna/content/json.rb",
    "lib/rakuna/provides/json.rb",
    "rakuna-content-json.gemspec",
    "spec/rakuna/content/json_spec.rb",
    "spec/spec_helper.rb"
  ]
  s.homepage = "http://github.com/colstrom/rakuna-content-json"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.4.5.1"
  s.summary = "JSON mixins for Rakuna and Webmachine"
